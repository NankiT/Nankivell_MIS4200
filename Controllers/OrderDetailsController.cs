...
namespace Nankivell_MIS4200.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "orderdetailID,qtyOrdered,price,orderID,productID")] OrderDetails orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "orderdetailID,qtyOrdered,price,orderID,productID")] OrderDetails orderDetail)
        {
            if (ModelState.IsValid)
            {
