...
namespace Nankivell_MIS4200.Controllers
{
    public class EpisodeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "episodeId,episodeTitle,Season")] Episode episode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "episodeId,episodeTitle,Season")] Episode episode)
        {
            if (ModelState.IsValid)
            {
